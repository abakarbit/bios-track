    ...
    <div class="col-lg-8">
                        ...
                        <tr>
                            ...
                            <td class="small">
                                ...
                                <small class="d-block text-muted">
                                    ...
                                    {{ $bimbingan->progresses->count() }} catatan progress
                                </small>
                            </td>
                            <td class="small">
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover table-sm mb-0">
                        <thead class="table-light"><tr><th>Jenis</th><th>Tanggal</th><th>Tempat</th><th>Nilai</th><th>Status</th><th></th></tr></thead>
                        <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{ route('kaprodi.ujian.show', $ujian) }}" class="btn btn-xs btn-outline-secondary" style="font-size:.7rem;padding:2px 6px"><i class="bi bi-eye"></i></a></td>
                        </tr>
                        @empty
                        <tr><td colspan="6" class="text-center py-3 text-muted small">Belum ada ujian.</td></tr>
                        @endforelse
                        </tbody>
                    </table>
                </div>
