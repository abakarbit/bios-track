...
<div class="card">
        ...
        <div class="table-responsive">
            <table class="table table-hover mb-0">
                ...
                <tr>
                    ...
                    <td><a href="{{ route('kaprodi.mahasiswa.detail', $mhs) }}" class="btn btn-sm btn-outline-primary"><i class="bi bi-eye me-1"></i>Detail</a></td>
                </tr>
                @empty
    ...
    <div class="card-footer">{{ $mahasiswas->withQueryString()->links() }}</div>
    @endif
</div>
@endsection
